...
(globalThis as any).Chart = jest.fn((ctx, config) => mockChart);
...
describe('AdvanceSettings', () => {
  ...
  beforeEach(() => {
    ...
    `;
    container = document.querySelector('.advanced_features_container') as HTMLElement;
  ...
  describe('Time Settings', () => {
    it('should handle automatic time settings', () => {
      ...
      // Test auto-on time
      const autoOnInput = container.querySelector('#autoOnTime') as HTMLInputElement;
      const autoOnOkayBtn = container.querySelector('.defaultOn-okay') as HTMLElement;
      ...
      // Test auto-off time
      const autoOffInput = container.querySelector('#autoOffTime') as HTMLInputElement;
      const autoOffOkayBtn = container.querySelector('.defaultOff-okay') as HTMLElement;
